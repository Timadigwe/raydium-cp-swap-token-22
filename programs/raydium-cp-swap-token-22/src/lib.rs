...
use curve::FEE_RATE_DENOMINATOR_VALUE;
pub mod curve;
pub mod error;
...
declare_id!("HJP61gQgQTzTkT7eXfz3WCzfiF2KmPhVWE2e4Yjc4VLT");

pub mod admin {
    use super::{pubkey, Pubkey};
    #[cfg(not(feature = "devnet"))]
    pub const ID: Pubkey = pubkey!("HwRUZB9GziXthyTZ47GmwQqQFwcuF1T4Pn8KhSLrGafB");
}
...
#[program]
pub mod raydium_cp_swap_token_22 {
    use super::*;
